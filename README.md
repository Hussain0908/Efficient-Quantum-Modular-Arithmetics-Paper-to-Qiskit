...
- Fully implemented Qiskit circuits for modular adders, multipliers, and exponential operators  
- Clean, modular Python code  
- Example simulations and demonstrations  
- Building blocks for integrating modular arithmetic into algorithms like **Shor’s algorithm**
...
Implements:
\[
\text{Add}_{\text{in}}(k,N)|a\rangle \rightarrow |a + k \mod N\rangle
\]
...
\[
\text{Add}_{\text{out}}(k,N)|a\rangle|0\rangle \rightarrow |a\rangle|a + k \mod N\rangle
\]
...
\[
|a\rangle|b\rangle \rightarrow |a\rangle|a + b \mod N\rangle
\]
...
\[
|a\rangle|b\rangle|0\rangle \rightarrow |a\rangle|b\rangle|a + b \mod N\rangle
\]
...
\[
|a\rangle|b\rangle \rightarrow |a\rangle|b + ka \mod N\rangle
\]
...
\[
|a\rangle \rightarrow |ka \mod N\rangle
\]
...
\[
|a\rangle|b\rangle|0\rangle \rightarrow |a\rangle|b\rangle|ab \mod N\rangle
\]
...
\[
|a\rangle|b\rangle \rightarrow |a\rangle|ab \mod N\rangle
\]
...
\[
|x\rangle|1\rangle|0\rangle \rightarrow |x\rangle|a^{x} \mod N\rangle|0\rangle
\]

Constructed using controlled modular multipliers and precomputed values of  
\[
a^{2^i} \mod N.
\]
